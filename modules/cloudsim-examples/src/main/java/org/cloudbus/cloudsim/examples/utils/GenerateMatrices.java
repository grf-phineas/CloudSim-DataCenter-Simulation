...
public class GenerateMatrices {
    ...
    private File commFile = new File("E:\\CloudsimCode\\cloudsim-web\\CommunicationTimeMatrix.txt");
    private File execFile = new File("E:\\CloudsimCode\\cloudsim-web\\ExecutionTimeMatrix.txt");

    public GenerateMatrices() {
//        commMatrix = new double[Constants.NO_OF_TASKS][40];
//        execMatrix = new double[Constants.NO_OF_TASKS][40];
        commMatrix = new double[400][40];
        execMatrix = new double[400][40];
        try {
