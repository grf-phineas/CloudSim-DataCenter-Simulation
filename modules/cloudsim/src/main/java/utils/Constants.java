...
public class Constants {
    ...
    public static int NO_OF_Iterations = 40;
    //ACO
    public static int NO_OF_ANTS = 25;
    ...
    //Cloudlet Parameters
    public static int NO_OF_TASKS = 50;
    ...
    public static void setNoOfDatacenters(int noOfDatacenters) {
        NO_OF_DATACENTERS = noOfDatacenters;
    }
